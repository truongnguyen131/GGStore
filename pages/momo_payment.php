...
<div class="container">
    ...
    <a href="" id="QR_MOMO" class="button button--piyo">
        <div class="button__wrapper">
            <span class="button__text">QR Code</span>
        </div>
    ...
    <a href="" id="QR_ATM" class="button button--hoo">
        <div class="button__wrapper">
            <span class="button__text">ATM</span>
        </div>
        <div class="characterBox">
            <div class="character wakeup">
                <div class="character__face"></div>
    ...
    <a href="javascript:back()" class="button button--pen">
        <div class="button__wrapper">
