...
function main()
{
    ...
    if (isset($_GET["delete"])) {
        $id = $_GET["delete"];
        $query = "DELETE FROM `news_comments` WHERE id = ?";
        ...
        echo "<script>location.href='news_comments.php';</script>";
    }
    ...
    $query = "SELECT nc.*, u.full_name FROM news_comments nc, users u WHERE nc.user_id = u.id AND u.full_name LIKE ? ";
        ...
        <form method="post" name="frmDataDiscount">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">DataTable News Comment</h6>
                </div>
                <div class="card-body">
                                        ...
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                                        colspan="1"
                                                        aria-label="Contents of comments: activate to sort column ascending"
                                                        style="width: 210px;">
                                                        Contents of comments</th>
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 text-md-right mt-3">
                                        <div class="dataTables_info" aria-live="polite">
                                            <a href="./add_news_comment.php">Add news comment</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function performDelete(event) {
            ...
            var url = "news_comments.php?delete=" + encodeURIComponent(id);
